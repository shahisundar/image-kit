...
<script lang="ts">
  export let options;
  export let onUpdate: (resizeOptions: { _width: number | null; _height: number | null; _aspectRatio: string; crop: string; _gravity: string | { x: number; y: number } }) => void = (resizeOptions) => {};
...
<div class="resizer-container">
  ...
  <div class="form-group">
    ...
    <select
      id="gravity"
      bind:value={gravity}
      on:change={(e) => toggleCustomGravity((e.target as HTMLSelectElement).value)}
